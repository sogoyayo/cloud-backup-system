...
// class UserModel {
    ...
    export async function createUser(id: string, email: string, password: string, fullName: string, role: UserRole): Promise<void> {
    ...
    export async function updateUser(id: number, email: string, fullName: string): Promise<void> {
